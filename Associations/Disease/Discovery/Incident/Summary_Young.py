...
results_dir_lst = sort_nicely(glob.glob(dpath + 'Results/Associations/Discovery/Incident/'+group+'/*.csv'))
...
meta_df = meta_df.loc[meta_df.Age < 60]
...
mydf.to_csv(dpath + 'Results/Associations/Discovery/Incident/Summary/Data_Summary_'+group+'.csv', index = False)
