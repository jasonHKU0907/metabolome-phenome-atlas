...
badoutfile = dpath + 'Results/Associations/Discovery/Prevalent/bad_tgt_male.csv'
...
for tgt_name in tqdm(tgt_lst):
    ...
    try:
        if tmp_df.target_y.sum()>=50:
            ...
            tgt_out_df.to_csv(dpath + 'Results/Associations/Discovery/Prevalent/Male/' + tgt_name + '.csv', index=False)
        else:
