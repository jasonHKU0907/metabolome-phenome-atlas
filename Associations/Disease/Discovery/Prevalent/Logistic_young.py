...
badoutfile = dpath + 'Results/Associations/Discovery/Prevalent/bad_tgt_young.csv'
...
for tgt_name in tqdm(tgt_lst):
    ...
    try:
        if tmp_df.target_y.sum()>=50:
            ...
            tgt_out_df.to_csv(dpath + 'Results/Associations/Discovery/Prevalent/Young/'+tgt_name+'.csv', index=False)
        else:
...
scp -P 59813 -r /Volumes/JasonWork/Projects/MetaAtlas/SeverCode/Associations jiayou@10.190.248.211:/home1/jiayou/Documents/Projects/MetaAtlas/SeverCode/
