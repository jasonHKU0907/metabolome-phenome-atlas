...
results_dir_lst = sort_nicely(glob.glob(dpath + 'Results/Associations/Discovery/Prevalent/'+group+'/*.csv'))
...
mydf.to_csv(dpath + 'Results/Associations/Discovery/Prevalent/Summary/Data_Summary_'+group+'.csv', index = False)
