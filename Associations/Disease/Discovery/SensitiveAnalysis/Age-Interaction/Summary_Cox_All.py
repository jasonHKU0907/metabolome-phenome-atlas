...
results_dir_lst = sort_nicely(glob.glob(dpath + 'Revision/Results/Associations/Discovery/Incident/'+group+'/*.csv'))
...
mydf.to_csv(dpath + 'Revision/Results/Associations/Discovery/Incident/Summary/Data_Summary_'+group+'.csv', index = False)
