...
results_dir_lst = sort_nicely(glob.glob(dpath + 'Results/Associations/Replication_nonWhite/Prevalent/'+group+'/*.csv'))
...
mydf.to_csv(dpath + 'Results/Associations/Replication_nonWhite/Prevalent/Summary/Data_Summary_'+group+'.csv', index = False)
