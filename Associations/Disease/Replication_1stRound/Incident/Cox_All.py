...
badoutfile = dpath + 'Results/Associations/Replication_1stRound/Incident/bad_tgt_all.csv'
...
for tgt_name in tqdm(tgt_lst):
    ...
    try:
        ...
        if tmp_df.target_y.sum()>=50:
            ...
            tgt_out_df.to_csv(dpath + 'Results/Associations/Replication_1stRound/Incident/All/' + tgt_name + '.csv', index=False)
        else:
...
#SBATCH -n 30           # Number of tasks to be launched
#SBATCH --mem=96G
#SBATCH -J i_r1rd_all           # Job name
#SBATCH -o i_all.out       # Standard output
#SBATCH -w amdnode3

cd /home1/jiayou/Documents/Projects/MetaAtlas/SeverCode/Associations/Replication-1stRound/Incident/
python Cox_all.py