...
results_dir_lst = sort_nicely(glob.glob(dpath + 'Results/Associations/Replication_1stRound/Incident/'+group+'/*.csv'))
...
meta_df = meta_df.loc[meta_df.Split == 2]
...
mydf.to_csv(dpath + 'Results/Associations/Replication_1stRound/Incident/Summary/Data_Summary_'+group+'.csv', index = False)
