...
badoutfile = dpath + 'Results/Associations/Replication_1stRound/Prevalent/bad_tgt_all.csv'
...
for tgt_name in tqdm(tgt_lst):
    ...
    try:
        if tmp_df.target_y.sum()>=50:
            ...
            tgt_out_df.to_csv(dpath + 'Results/Associations/Replication_1stRound/Prevalent/All/' + tgt_name + '.csv', index=False)
        else:
...
#SBATCH -n 20           # Number of tasks to be launched
#SBATCH --mem=64G
#SBATCH -J p_r1rd_all           # Job name
#SBATCH -o p_all.out       # Standard output
#SBATCH -w node68

cd /home1/jiayou/Documents/Projects/MetaAtlas/SeverCode/Associations/Replication-1stRound/Prevalent/
python Log_all.py
