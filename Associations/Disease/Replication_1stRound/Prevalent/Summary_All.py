...
results_dir_lst = sort_nicely(glob.glob(dpath + 'Results/Associations/Replication_1stRound/Prevalent/'+group+'/*.csv'))
...
mydf.to_csv(dpath + 'Results/Associations/Replication_1stRound/Prevalent/Summary/Data_Summary_'+group+'.csv', index = False)
