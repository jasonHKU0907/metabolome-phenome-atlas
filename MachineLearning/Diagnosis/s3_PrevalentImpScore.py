...
tgt_dir_lst = sort_nicely(glob.glob(dpath + 'Revision/Results/Prediction/Prevalent/NMR_Importance/*.csv'))
...
for tgt_dir in tqdm(tgt_dir_lst):
    ...
    output_img = dpath + 'Revision/Results/Prediction/Prevalent/Importance_Plot/' + tgt + '.pdf'
