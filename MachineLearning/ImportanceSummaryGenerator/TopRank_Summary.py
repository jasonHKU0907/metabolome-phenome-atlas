...
for root in tqdm(root_lst):
    ...
    for name in name_lst:
        ...
        tgt_imp_df.sort_values(by = 'Importance', ascending=False, inplace = True)
    ...
    name_imp_df.to_csv(dpath + 'Revision/Results/Prediction/'+type+'/ImportanceSummary/Top'+str(top_nb)+'_summary/'+root_name+'.csv', index = False)
...
root_imp_df.to_csv(dpath + 'Revision/Results/Prediction/'+type+'/ImportanceSummary/Top'+str(top_nb)+'_summary/Importance_by_root.csv', index = False)
